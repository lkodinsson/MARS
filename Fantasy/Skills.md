...
Animists do not require or use scrolls or spell books. Nature itself teaches you how to wield it. You acquire a new spell from your specialization when you advance your animism skill. You can only have one animism specialization, as they are fundamentally conflicting representations of animism.

As you advance in animism you also get bonus spells at specific ranks, regardless of the specialization you choose. You get these spells in addition to spells you learn from advancing normally.

##### Table: Animism Bonus Spells
| Roll Value | Step Name | Bonus Spell |
|:-:|:-|:-|
| r4 | Trained | Speak to Animals (?) |
| r8 | Practiced | Animal Form (?) |
...
| Concentration<br/>For Effect<br/>(Unlimited Uses) | Magic Cost × 5 |
